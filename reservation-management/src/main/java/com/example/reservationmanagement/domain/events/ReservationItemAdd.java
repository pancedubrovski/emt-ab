...
@Getter
public class ReservationItemAdd implements DomainEvent {
    ...
    @JsonCreator
    public ReservationItemAdd(ReservationId reservationId,  ReservationItemId reservationItemId, FlightId flightId,  int sets, Instant occurredOn) {
