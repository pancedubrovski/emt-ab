...
public class ReservationItemDelete implements DomainEvent {
    ...
    @JsonCreator
    public ReservationItemDelete(ReservationId reservationId, ReservationItemId reservationItemId, FlightId flightId,int sets, Instant occurredOn) {
