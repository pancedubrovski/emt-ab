...
@Getter
public class ReservationItemAddEvent implements DomainEvent {
    ...
    @JsonCreator
    public ReservationItemAddEvent(ReservationId reservationId , ReservationItemId reservationItemId,FlightId flightId,  int sets, Instant occurredOn) {
